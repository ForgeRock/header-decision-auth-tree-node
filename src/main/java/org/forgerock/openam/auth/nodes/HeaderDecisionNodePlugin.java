 ...
 */
public class HeaderDecisionNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public HeaderDecisionNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
